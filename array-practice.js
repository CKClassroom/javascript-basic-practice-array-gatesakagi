...
removeItem(people, 'James');
console.log('3 - ', people);
function removeItem(targetArray, targetName) {
  let indexOftargetName = targetArray.indexOf(targetName);
  let removedItem = targetArray.splice(indexOftargetName, 1);
}
